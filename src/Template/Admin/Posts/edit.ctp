      ...
      <div class="card">
        ...
        <div class="content">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <?php echo $this->Form->control('slug', ['class'=>'form-control', 'label'=>'Slug', 'readonly']);?>
              </div>
            </div>
          </div>
          ...
          <!-- <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <?php //echo $this->Form->control('important', ['class'=>'', 'label'=>'Destaque', 'options'=>[0=>'Não',1=>'Sim']]);?>
              </div>
            </div>
          </div> -->
            ...
            <div class="col-md-9">
              <div class="form-group">
                ...
                <figure class="form-box-img">
                  ...
                  <?php else:?>
                    <img class="img-rounded form-img" src="http://via.placeholder.com/1440x520">
                  <?php endif;?>
