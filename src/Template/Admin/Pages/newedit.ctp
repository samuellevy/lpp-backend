              ...
              <div class="boilerplate">
                <div class="row row-dashed banner-component-boilerplate" data-id="banner-{banner_id}" data-component="<?=$key?>">
                    ...
                    <div class="col-md-3 flex-options">
                      <?=$this->Form->hidden('pages_components_boilerplate.{key}.id', ['class'=>'form-control', 'value'=>'{key}']);?>

                      <label>Imagem</label>
                      <img src="http://via.placeholder.com/290x130" alt="" class="scaled-img"/>
                    ...
                    <div class="col-md-3 flex-options">
                      ...
                      <?=$this->Form->control('pages_components_boilerplate.{key}.banners.{banner_key}.class', ['class'=>'form-control', 'label'=>'Classe do botão (blue, green, etc)', 'value'=>'blue']);?>
