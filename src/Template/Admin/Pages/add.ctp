            ...
            <div class="col-md-10">
                ...
                <figure class="form-group">
                  <ul id="sortable" style="list-style:none;padding:0;">
                    <li style="cursor:move" data-sort="0">
                      ...
                      <?php echo $this->Form->hidden('pages_components.0.sort', ['class'=>'form-control sortfield', 'value'=>0]);?>
                      <?php echo $this->Form->control('pages_components.0.content', ['class'=>'form-control ckeditor', 'label'=>'Banner']);?>
                    </li>
                  </ul>
                </figure>
              </div>
              ...
              <div class="form-group">
                <figure class="form-group">
                  <ul id="sortable" style="list-style:none;padding:0;">
                    <li style="cursor:move" data-sort="0">
                      <?php echo $this->Form->hidden('pages_components.1.id', ['class'=>'form-control']);?>
                      <?php echo $this->Form->hidden('pages_components.1.component_id', ['class'=>'form-control sortfield', 'value'=>2]);?>
                      <?php echo $this->Form->hidden('pages_components.1.sort', ['class'=>'form-control sortfield', 'value'=>1]);?>
                      <?php echo $this->Form->control('pages_components.1.content', ['class'=>'form-control ckeditor', 'label'=>'Conteúdo']);?>
                    </li>
                  </ul>
                </figure>
              </div>
