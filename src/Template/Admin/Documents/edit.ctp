            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <figure class="form-box-img">
                  <?php if(isset($document['files'][0])):?>
                    <button type="button" class="btn btn-danger btn-fill remove" data-uid="<?=$document['files'][0]['id'];?>">Remover</button>
                    <iframe src="<?=$this->Url->build('/documents/'.$document['files'][0]['filename'])?>"></iframe>
                  <?php else:?>
