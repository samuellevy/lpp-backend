<div class="content_maes" ondragstart="return false;" ondrop="return false;">
    <div class="scenes">
        ...
        <div class="click-mobile">
            <img src="../images/button-mobile.png" alt="">
        </div>
        <div class="bg-mobile">
            <div class="bg"></div>
        </div>
        <section class="scene choose_model_container" data-scene="1">
            <div class="box-wrap">
                <div class="box_choose_model">
                    ...
                    <div class="description"><span>Pra começar, escolha qual dos dois modelos<br/> é mais parecido com a sua mãe.</span><img src="../images/interrogation-dot.png" alt=""></div>
                </div>
                <div class="mother-choose">
                    <div class="content">
                        <div id="mother1"><a class="chooseModelBtn" href="#" data-model="a">
                            <img src="../images/mother01.png" alt="">
                            <span>É esse!</span></a>
                        </div>
                        <div id="mother2"> <a class="chooseModelBtn" href="#" data-model="b">
                            <img src="../images/mother02.png" alt="">
                            <span>É esse!</span></a>
                        </div>
                    </div>
                </div>
        ...
        <section class="scene scene-choose-file" data-scene="2">
            <div class="box-choose-file">
                <div class="box-wrap">
                    <div class="media"><img class="model-doll" src="../images/diadasmaes/model-a.png" alt="" style="width:519px;" data-model="a"><img class="model-doll" src="../images/diadasmaes/model-b.png" alt="" style="width:519px;" data-model="b"></div>
                    <div class="text">
            ...
            <section class="scene setSize" data-scene="3">
                ...
                <div class="box-wrap">
                    ...
                    <div class="work-container">
                        <div class="work-box" id="work-box"><img class="preview" id="preview" src="" alt=""><img id="mask" src="../images/diadasmaes/mask.png"><img id="image-mask" src="../images/diadasmaes/new-mask-black.png">
            ...
            <section class="scene box-card-ready" data-scene="4">
                ...
                <div class="box-wrap">
                    <div class="media"><img id="finalImage" src="../images/mother2-choose.png" alt=""></div>
                    <div class="text">
                        <h4>seu cartão está pronto!</h4>
